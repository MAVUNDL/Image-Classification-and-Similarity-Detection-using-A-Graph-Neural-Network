package BackEnd.Algorithms.preprocessing.utilization;

import BackEnd.Algorithms.preprocessing.abstraction.FeatureExtraction;
import BackEnd.Algorithms.preprocessing.processing.ProcessingImage;
...
public class Patch  extends FeatureExtraction{
    ...
    public double edgeDensity(){
        ProcessingImage processor = new ProcessingImage();
        return processor.computeEdgeDensity(processor.cannyEdgeImage(this.patch));
    }
